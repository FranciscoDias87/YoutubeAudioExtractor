...
class YouTubeAudioExtractorGUI(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("YouTube Audio Extractor - Vídeos e Playlists")
        ...
        # Subtítulo
        subtitle_label = QLabel("Baixe áudio de vídeos únicos ou playlists completas")
        ...
        self.url_input.setPlaceholderText("Cole aqui a URL do vídeo ou playlist do YouTube...")
        self.url_input.setMinimumHeight(35)
        url_layout.addWidget(self.url_input)
        
        # Checkbox para playlist
        self.playlist_checkbox = QCheckBox("Esta URL é uma playlist")
        self.playlist_checkbox.setToolTip("Marque esta opção se a URL for de uma playlist do YouTube")
        ...
        info_layout.addWidget(QLabel("Tipo:"), 2, 0)
        ...
        try:
            ...
            with yt_dlp.YoutubeDL(ydl_opts) as ydl:
                ...
                if is_playlist:
                    ...
                    self.log_message(f"Playlist detectada com {entries_count} vídeos")
                else:
                    self.type_label.setText("Vídeo único")
                    self.playlist_checkbox.setChecked(False)
                    self.log_message("Vídeo único detectado")
    ...
    def download_finished(self, filename, message):
        ...
        # Mostrar mensagem de sucesso diferente para playlist vs vídeo
